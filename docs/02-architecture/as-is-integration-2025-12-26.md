# ⚠️ OBSOLETE DOCUMENT - AS-IS: Интеграции монолита с микросервисами и внешними системами (26.12.2025)

**СТАТУС:** УСТАРЕЛО - см. актуальную документацию ниже  
**ДАТА УСТАРЕВАНИЯ:** 23.01.2026

**Актуальные документы:**
- [BACKEND_ARCHITECTURE_OVERVIEW.md](BACKEND_ARCHITECTURE_OVERVIEW.md) - Текущая архитектура
- [MICROSERVICES_PATTERNS_ROADMAP.md](../MICROSERVICES_PATTERNS_ROADMAP.md) - План развития
- [api-gateway-service.md](../05-microservices/api-gateway-service.md) - API Gateway

---

**ИСТОРИЧЕСКАЯ ИНФОРМАЦИЯ (26.12.2025):**

Документ фиксирует ПРОШЛОЕ состояние взаимодействий монолита с внешними микросервисами и системами.
