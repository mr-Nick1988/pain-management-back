...
public class SodiumRuleApplier implements TreatmentRuleApplier {
    ...
    public void apply(DrugRecommendation drug,
        ...
        // 1 Пропуск, if drug уже очищен or пуст
        ...
        // 3 Extract числовой порог from строки protocolа (наExample "<130 - avoid" → 130)
        ...
        if (patientSodium < limitDouble) {
            ...
            // Add строку причину отклонения for отклонённой recommendation (recommendationFailed)
