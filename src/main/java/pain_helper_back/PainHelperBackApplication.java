...
/*
 * Главный Class приложения Pain Management Assistant.
 * 
 * ВКЛЮЧЕННЫЕ ФУНКЦИИ:
 ...
 * - PainMonitoringScheduler.checkOverdueDoses() - each час
 * - PainMonitoringScheduler.dailyEscalationSummary() - ежедневно в 08:00
 */
@SpringBootApplication
@EnableScheduling  // Включаем поддержку @Scheduled for автоматической EMR синхронfromации
